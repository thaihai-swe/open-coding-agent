#!/usr/bin/env python3
"""Embedded CoreZero command-line interface."""
...
COMMANDS = {
    "init": ("initialize CoreZero repository scaffolding", "core.handlers.lifecycle", "init"),
...
def _parser():
    parser = argparse.ArgumentParser(prog="core-zero", description="CoreZero local workflow operations")
