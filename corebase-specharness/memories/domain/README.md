...
Each domain subdirectory under `corebase-specharness/memories/domain/` is a self-contained domain pack with 4 required files (plus an optional `spec.md`).
...
1. Create directory: `corebase-specharness/memories/domain/<name>`
...
`corebase-specharness/memories/domain/`. CoreBase SpecHarness discovers this form for backward
